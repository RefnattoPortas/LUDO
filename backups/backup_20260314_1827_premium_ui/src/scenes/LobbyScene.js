...
export class LobbyScene extends Phaser.Scene {
    ...
    async create() {
        ...
        this.roomsContainer = this.add.container(cx, 260);
    ...
    createAddButtons(x, y) {
        const btn2 = this.createSmallButton(x - 90, y, "CRIAR 2 JOG.", 0x4CAF50, () => this.findOrCreateAndJoin(2));
        const btn4 = this.createSmallButton(x + 90, y, "CRIAR 4 JOG.", 0x2196F3, () => this.findOrCreateAndJoin(4));
    }
